 ...
 *
 * Disassembly of SSDT-10.aml, Sat Nov  3 16:02:37 2018
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00003FB1 (16305)
 *     Revision         0x01
 *     Checksum         0x00
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
DefinitionBlock ("", "SSDT", 1, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.EC6I, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.LPCB.EC0_.EC6O, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.LPCB.EC0_.FBST, UnknownObj)    // Warning: Unknown object
    External (_SB_.PCI0.LPCB.H_EC.PCA2, MethodObj)    // 0 Arguments
    ...
    {
        OperationRegion (VBOR, SystemMemory, 0x7CE17018, 0x00040004)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        OperationRegion (SGOP, SystemMemory, 0x7CC7EF98, 0x00000045)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        OperationRegion (NOPR, SystemMemory, 0x7CE7B018, 0x00002010)
        ...
        Method (GPS, 4, Serialized)
        {
            ...
            Switch (ToInteger (Arg2))
            {
                ...
                Case (0x22)
                {
                    ...
                    Store (NPPC, PSAP)
                    Return (\_SB.PCI0.LPCB.H_EC.PCA2 ())
                }
                Case (0x23)
                {
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        Method (GC6I, 0, Serialized)
        {
            ...
            Store (Zero, \_SB.PCI0.LPCB.EC0.EC6O)
        }
        ...
        Method (GC6O, 0, Serialized)
        {
            ...
            Store (Zero, \_SB.PCI0.LPCB.EC0.EC6I)
        }
        ...
        Method (GETS, 0, Serialized)
        {
            ...
            ElseIf (LEqual (\_SB.PCI0.LPCB.EC0.FBST, Zero))
            {
                Return (0x02)
            }
            Else
